-- Active: 1712401392241@@127.0.0.1@3307
...
--
-- Table structure for user credentials
--
...
INSERT INTO `users` (`email`, `hash`, `isAdmin`) VALUES ('admin@ment.com', '$2a$08$Sbrej2.i3KcdBhuNGxyAXOms0mXXyzSxhhCpuh1e4F8bIv0umcApm', TRUE);
